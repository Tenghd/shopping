...
<html>
 ...
 <form  method="post" action="/shopping/a/ChangeUserMessageAction">
  <table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
    ...
    <tr>
      ...
      <td width="60%" class="tablebody1">
        <input type="text" name="username" maxlength="16" size="32" value="${sessionScope.user.username }" 
    ...
    <tr>
      ...
      <td width="60%" class="tablebody1">
	<input type="text" name="password"  size="32" value="${sessionScope.user.password }" 
	...
	<td class="tablebody1"><b>真实姓名</b>：</td>
        <td class="tablebody1">
          <input type="text" name="name" maxlength="32" size="64" value="${sessionScope.user.name }" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000"></td>
    </tr>
    <tr>
	<td class="tablebody1"><b>联系地址</b>：</td>
        <td class="tablebody1">
          <input type="text" name="address" maxlength="32" size="64" value="${sessionScope.user.address }" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000"></td>
    </tr>
    <tr>
	<td class="tablebody1"><b>邮编</b>：</td>
        <td class="tablebody1">
          <input type="text" name="zip" maxlength="8" size="32" value="${sessionScope.user.zip }" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
        </td>
    </tr>
    <tr>
